...
namespace Task2_2
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            bool firstSuccessInput = int.TryParse(Console.ReadLine(), out firstNumber);
            Console.Write("Number 2: ");
            bool secondSuccessInput = int.TryParse(Console.ReadLine(), out secondNumber);
            Console.Write("Number 3: ");
            bool thirdSuccessInput = int.TryParse(Console.ReadLine(), out thirdNumber);
